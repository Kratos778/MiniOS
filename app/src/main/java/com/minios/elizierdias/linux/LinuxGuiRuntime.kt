...
class LinuxGuiRuntime(
    ...
    fun ensureXstartup(): String {
        ...
        // Script simples — sem escapes ilegais Kotlin (\\& partiu builds #230+)
        val script = """
            |#!/bin/sh
            ...
            |  xterm -geometry 200x48+8+8 -fa Monospace -fs 11 -bg black -fg grey -ls -title "NoskOS Linux" &
            |fi
            |wait
            """.trimMargin().replace("$$HOME", 